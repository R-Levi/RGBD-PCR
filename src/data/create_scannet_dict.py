...
def create_scannet_dict(data_root, dict_path, split):
    ...
    for s_id in tqdm(scenes):
        ...
        int_path = os.path.join(
            data_root, split, "scans", s_id, "intrinsic/intrinsic_depth.txt"
        )
        ...
        for f_id in rgb_files:
            ...
            # populate dictionary
            inst_dict[f_id] = {
                "rgb_path": os.path.join(rgb_rel, "{}.png".format(f_id)),
...
if __name__ == "__main__":
    ...
    parser.add_argument("data_root", type=str,default='/home/levi/Data_work/workplace/scan_test_out/')
